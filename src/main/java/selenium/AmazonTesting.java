...
public class AmazonTesting {
	...
	private void clickAllMenuOption() throws InterruptedException {
		if (driver.findElement(By.xpath("//a[@id=\"nav-hamburger-menu\"]")).isDisplayed()) {
			...
			System.out.println("************************MAIN HEADINGS UNDER ALL START************************************");
			for (WebElement ele : allElementsHeadings) {
				if (!ele.getText().equals("") && ele.getText() != null) {
					System.out.println(ele.getText());
				}
			}
			System.out.println("************************MAIN HEADINGS UNDER ALL END************************************");
	...
	private void readMenus() {
		...
		HashMap<String, String> linkTextWithLink = new HashMap<>();
	...
	private void checkHelloSignInLangugeSelection() throws InterruptedException {
